...
def main():
    ...
    print("Database and tables setup completed in time: ", time.time()-start)
    ...
    authors_file.close()
    print("First reading completed in time: ", time.time()-start)
    ...
    print("Second reading completed in time: ", time.time()-start)
